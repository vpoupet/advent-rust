...
fn make_stacks() -> Vec<Vec<char>> {
    ...
    let input = utils::read_input("src/year2022/day05/start.txt").unwrap();
...
pub fn solve1() -> String {
    ...
    let input = utils::read_input("src/year2022/day05/moves.txt").unwrap();
    for line in input.lines() {
