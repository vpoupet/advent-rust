...
pub fn solve1() -> i32 {
    // parse instructions
    let (_, instructions) =
        parse_moves(&utils::read_input("src/year2022/day22/instructions.txt").unwrap()).unwrap();

    // parse map
    let map = parse_map("src/year2022/day22/map.txt");
...
pub fn solve2() -> i32 {
    ...
    // make cube from map
    let cube = Cube::new("src/year2022/day22/map.txt", 50);
